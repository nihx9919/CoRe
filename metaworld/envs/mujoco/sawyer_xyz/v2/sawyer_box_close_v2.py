...
class SawyerBoxCloseEnvV2(SawyerXYZEnv):
    def __init__(self, tasks=None, render_mode=None):
        ...
        obj_low = (0, 0.5, 0.02)
        obj_high = (0, 0.5, 0.02)
        goal_low = (0, 0.75, 0.133)
        goal_high = (0, 0.75, 0.133)
        ...
        self.init_config = {
            ...
            "obj_init_pos": np.array([0, 0.5, 0.02], dtype=np.float32),
            # "hand_init_pos": np.array((0, 0.6, 0.2), dtype=np.float32),
            "hand_init_pos": np.array((0, 0.5, 0.1), dtype=np.float32),
        }
    ...
    def reset_model(self):
        ...
        self.obj_init_pos = np.concatenate((goal_pos[:2], [-0.06]))
