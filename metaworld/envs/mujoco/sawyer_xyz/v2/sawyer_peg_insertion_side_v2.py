...
class SawyerPegInsertionSideEnvV2(SawyerXYZEnv):
    ...
    def __init__(self, tasks=None, render_mode=None, obj=(0.1, 0.6, 0.015)):
        ...
        obj_high = (0.1, 0.6, 0.015)
        # obj_low, obj_high = obj, obj

        goal_low = (-0.3, 0.55, -0.001)
        goal_high = (-0.3, 0.55, 0.001)
        ...
        self.init_config = {
            ...
            "hand_init_pos": np.array([0.1, 0.6, 0.05]),
        }
