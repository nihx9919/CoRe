class:
    ...
    def compute_observations(self):
        ...
        # In this task, first_obj_pos indicates the current position of grasping the peg and first_obj_quat indicates the quaternion of the peg. 
    ...
    # The target position is the hole position
    target_pos = self._target_pos
    # The position of the peg_head.
    peg_head_position = first_obj_pos + np.array([-0.12, 0, 0])
