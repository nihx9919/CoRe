class:
    ...
    def compute_observations(self):
        ...
        # In this task, first_obj_pos indicates the current position of the drawer handle and first_obj_quat indicates the quaternion of the drawer handle. 
    ...
    # The target position is the target position of the draer handle.
