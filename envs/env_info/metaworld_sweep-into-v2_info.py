class:
    ...
    def compute_observations(self):
        ...
        # In this task, first_obj_pos indicates the current position of the cube and first_obj_quat indicates the quaternion of the cube. 
    ...
    # The target position is the target position of the cube
